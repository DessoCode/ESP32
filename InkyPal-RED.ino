...
void pngDraw(PNGDRAW *pDraw) {
  ...
  for (int i = 0; i < 296; i++) {
    ...
    if (r > 200 && g > 200 && b > 200) {
      display.drawPixel(295 - i, pDraw->y, GxEPD_WHITE);
    } else if (r > 150 && g < 100 && b < 100) {
      display.drawPixel(295 - i, pDraw->y, GxEPD_RED); // This should appear as yellow
    } else {
      display.drawPixel(295 - i, pDraw->y, GxEPD_BLACK);
    }
  }
}
